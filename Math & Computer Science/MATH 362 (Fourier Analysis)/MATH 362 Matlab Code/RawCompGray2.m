...
figure, subplot(1,2,1), image(grayimage), colormap(Map), axis image 
subplot(1,2,2), image(graypic), colormap(Map), axis image 
subplot(1,2,1)
...
figure 
image(graypic), colormap(Map), axis image , title('Compressed Image')
