function FFTsoundthresh = FFTsoundthresh(x,sr,r,TZL,TZR,FZL,FZR)
global z PR CR 
...
subplot(3,2,2), timeplot(xt,1,N,sr), 
axis tight, xlabel('Time (sec)'),
title('Time Domain Plot of Thresholded Signal')

subplot(3,2,3), timeplot(x,KTL,KTR,sr), 
axis tight, xlabel('Time (sec)'),
...
%wavwrite2(xmw,sr,16,'FFT_ThresholdedWave.wav');

audiowrite('FFT_ThresholdedWave.wav',xt,sr);
