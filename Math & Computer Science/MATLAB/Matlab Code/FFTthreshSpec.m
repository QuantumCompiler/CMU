...
%cos(2Pi*k/T) -> freq = k/T and k = T*freq
kmax = round(ymax*TB);  %kmax = column length of D and is < N/2
...
DeltaF = round(1/TB*kmax/FreqTicks); %cos(2Pi*k/T) -> freq = k/T
...
audiowrite('FFTthreshSpec.wav',xm,sr);
