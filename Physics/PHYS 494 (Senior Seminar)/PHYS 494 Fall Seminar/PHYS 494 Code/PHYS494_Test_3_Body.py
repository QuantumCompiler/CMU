...
#################### Plots
plt.plot(x1list,y1list,"-k",label='Earth',linewidth=2.0)
plt.plot(x2list,y2list,"-y",label='Sun',linewidth=2.0)
plt.plot(x3list,y3list,"-g",label='Venus',linewidth=2.0)
